            ...
            {activeTab === "Home" && (
              <>
                ...
                <p>
                  ...
                  Ethereum to create better incentives, fund public goods,
                  foster coordination, and some day, to slay{" "}
                  <a
                    target="_blank"
              ...
              "
                ...
                <p>
                  Instead, out came pouring a torrent of sparkling coins and
                  jpegs, unfettered markets, and eye-watering levels of
                  leverage. It was all exciting and new, but it&apos;s hard not
                  to feel like something was lost along the way.
                </p>
                <p>
                ...
                <p>
                  ...
                  end-to-end governance platform for crypto protocols – the
                  first instance of at scale onchain collaboration. Leading
                  communities like{" "}
                  <a
                    target="_blank"
                ...
                <p>
                  Why? Because the invention of crypto token governance means
                  that for the first time in history, we have well defined ways
                  to improve protocols, and the in-network incentives to pay for
                  these improvements. The combination of these properties create
                  the pathway for a far larger range of technological progress
                  to move from private enterprises to common protocols.
                </p>
                <p>
                  But just because it&apos;s possible doesn&apos;t mean
                  it&apos;s going to happen. Administering the commons is one of
                  the oldest unsolved problems we know of. Except this time,
                  Ethereum has given us programmable incentives, and so we
                  tackle these old problems with new tools to expand the
                  frontiers of the commons.
                </p>
                <p>
                  We've got quite a lot started already, but there&apos;s much
                  more to the story here, and we&apos;d be honored if you&apos;d
                  join us in telling it.
                </p>
