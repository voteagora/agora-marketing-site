      ...
      <div className="mt-8 flex flex-row justify-between">
        <div className="w-1/6 p-1 -rotate-8 bg-white shadow-sm rounded-md transition-all duration-300 hover:rotate-0 hover:scale-125 ease-out hover:shadow-md hover:z-10">
          <img
            ...
            alt={"yitong"}
          ></img>
          <div className="text-xs text-center mt-1 font-serif italic text-stone-400">Yitong</div>
        </div>
        <div className="w-1/6 p-1 rotate-12 bg-white shadow-sm rounded-md transition-all duration-300 hover:rotate-0 hover:scale-125 ease-out hover:shadow-md hover:z-10">
          <img
            ...
            alt={"kent"}
          ></img>
          <div className="text-xs text-center mt-1 font-serif italic text-stone-400">Kent</div>
        </div>
        <div className="w-1/6 p-1 -rotate-6 bg-white shadow-sm rounded-md transition-all duration-300 hover:rotate-0 hover:scale-125 ease-out hover:shadow-md hover:z-10">
          <img
            ...
            alt={"charlie"}
          ></img>
          <div className="text-xs text-center mt-1 font-serif italic text-stone-400">Charlie</div>
        </div>
        <div className="w-1/6 p-1 rotate-8 bg-white shadow-sm rounded-md transition-all duration-300 hover:rotate-0 hover:scale-125 ease-out hover:shadow-md hover:z-10">
          <img
            className="rounded-sm"
            ...
            alt={"stepan"}
          ></img>
          <div className="text-xs text-center mt-1 font-serif italic text-stone-400">Stepan</div>
        </div>
        <div className="w-1/6 p-1 -rotate-6 bg-white shadow-sm rounded-md transition-all duration-300 hover:rotate-0 hover:scale-125 ease-out hover:shadow-md hover:z-10">
          <img
            className="rounded-sm"
            ...
            alt={"cats"}
          ></img>
          <div className="text-xs text-center mt-1 font-serif italic text-stone-400">Keyboard cats</div>
        </div>
        <div className="w-1/6 p-1 rotate-8 bg-white shadow-sm rounded-md transition-all duration-300 hover:rotate-0 hover:scale-125 ease-out hover:shadow-md hover:z-10">
          ...
          <div className="text-xs text-center mt-1 font-serif italic text-stone-400">You?</div>
        </div>
      </div>
    </section>
  );
